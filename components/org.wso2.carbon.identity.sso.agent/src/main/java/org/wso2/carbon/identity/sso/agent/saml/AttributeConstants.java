...
public class AttributeConstants {
    ...
    /** Attribute name for CurrentFamilyName. */
    public static final String EIDAS_LEGAL_PID_ATTRIBUTE_NAME = "http://eidas.europa.eu/attributes/legalperson/LegalPersonIdentifier";

    /** CurrentFamilyName friendly name. */
    public static final String EIDAS_LEGAL_PID_ATTRIBUTE_FRIENDLY_NAME = "LegalPersonIdentifier";

    /** Attribute name for CurrentFamilyName. */
    public static final String EIDAS_LEGAL_NAME_ATTRIBUTE_NAME = "http://eidas.europa.eu/attributes/legalperson/LegalName";

    /** CurrentFamilyName friendly name. */
    public static final String EIDAS_LEGAL_NAME_ATTRIBUTE_FRIENDLY_NAME = "LegalName";
